...
#define CMD_ERROR              B00000000
#define CMD_BEGIN              B00000001
#define CMD_END                B00000001

///////// Comandos para o servo
#define CMD_SERVO              (B00100000)

#define CMD_SERVO_NUM_OK       (B00100001) //33
#define CMD_SERVO_SET_ANGLE_OK (B00100010) //34

#define CMD_SERVO_GET_ANGLE_OK (B00100100) //36

#define CMD_SERVO_FIM          B00111111


//// comandos para o laser
